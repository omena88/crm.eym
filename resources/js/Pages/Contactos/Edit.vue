...
const form = useForm({
    ...
    apellidos: props.contacto.apellidos || '',
    puesto: props.contacto.puesto || '',
    telefono: props.contacto.telefono || '',
    celular: props.contacto.celular || '',
    email: props.contacto.email || '',
    es_contacto_principal: props.contacto.es_contacto_principal,
    notas: props.contacto.notas || '',
});
...
<template>
    <Head :title="`Editar Contacto - ${contacto.nombre_completo}`" />
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <Link 
                                ...
                                class="text-lg font-medium text-blue-400 hover:text-blue-300 transition-colors"
                            >
                                {{ contacto.cliente.razon_social }}
                            </Link>
                            <p class="text-gray-400">{{ contacto.cliente.codigo }} • {{ contacto.cliente.sector }}</p>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        ...
                        >
                            {{ form.processing ? 'Actualizando...' : 'Actualizar Contacto' }}
                        </PrimaryButton>
                    </div>
                </form>
            </div>
