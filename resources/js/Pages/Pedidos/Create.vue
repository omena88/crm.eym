    ...
    <AuthenticatedLayout>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-400 mt-1">
                        <span v-if="cotizacion">Basado en cotización existente</span>
                        <span v-else>Crear pedido desde cero</span>
                    </p>
                </div>
            </div>
        </template>
        ...
        <div class="py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div v-if="cotizacion" class="bg-blue-900/50 border border-blue-700 rounded-lg p-4 mb-6">
                    <h3 class="text-lg font-semibold text-blue-100 mb-2">Cotización Base</h3>
                    <p class="text-blue-200">
                        Este pedido se está creando basado en una cotización existente para 
                        <span class="font-medium">{{ cotizacion.cliente.razon_social }}</span>
                    </p>
                </div>
                            ...
                            <div class="bg-gray-900 border border-gray-800 rounded-lg p-6">
                                ...
                                <div class="mb-6">
                                    <div class="flex justify-between items-center mb-4">
                                        <h4 class="text-md font-semibold text-white">Productos</h4>
                                        <button 
                                            type="button"
                                        ...
                                        <div class="mb-3">
                                            <div class="relative">
                                                ...
                                                <input 
                                                    ...
                                                    class="w-full pl-10 pr-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                >
                                            </div>
                                        </div>
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-gray-900 border border-gray-800 rounded-lg p-6 sticky top-8">
                                ...
                                <div class="mt-6 space-y-3">
                                    ...
                                    >
                                        {{ form.processing ? 'Creando...' : 'Crear Pedido' }}
                                    </button>
